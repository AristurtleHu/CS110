...
loop:
	...
	add t4, t1, t3
	lw t5, 0(t4)
    andi t6, t0, 1    # Check if i is odd
    beq t6, x0, even  # If i is even, go to even case

    add t5, t0, x0    # For odd i, set dest[i] = i
    j last

    even:
    slli t5, t5, 1    # For even i, set dest[i] = 2 * source[i]
