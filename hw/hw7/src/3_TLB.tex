...
\begin{parts}
    ...
    The range of bits for the VPN (virtual page number) \blank[3cm]{[31:12]}.
    \vspace{0.5cm}

    The range of bits for the offset within a page \blank[3cm]{[11:0]}.
    \vspace{0.5cm}

    The range of bits for the TLB tag \blank[3cm]{[31:14]}.
    \vspace{0.5cm}

    The range of bits for the TLB set number \blank[3cm]{[13:12]}.
    \vspace{0.5cm}
