...
\newcommand{\blank}[2][2cm]{\underline{\makebox[#1][l]{#2}}}
...
\begin{CJK*}{UTF8}{gbsn}
    \begin{center}
        ...
        \vspace{0.1cm}
        \makebox[\textwidth]{Chinese Name:\enspace \underline{杨人一}}\\[0.6cm]
        \makebox[\textwidth]{Pinyin Name:\enspace \underline{Yang Renyi}}\\[0.6cm]
        \makebox[\textwidth]{Student ID: \enspace \underline{2023533030}}\\[0.6cm]
        \makebox[\textwidth]{E-Mail prefix:\enspace \underline{yangry2023}}\\[0.5cm]
